...
<head>
    <meta charset="UTF-8">
    <title>Blog Wiesława Pięcigróda</title>
    <style>
...
<body>
    ...
    <!-- Pasek nawigacji -->
    <div class="container" style="display: flex; align-items: center; gap: 15px; margin: 10px;">
        <img src="logo.jpeg" alt="Logo" style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%;">
        <div style="display: flex; gap: 30px; margin-left: auto; align-items: center;">
    ...
    <!-- Treść Bloga Wiesława -->
    <div class="blog-posts-container" style="padding: 40px; font-family: 'Courier New', Courier, monospace; min-height: 60vh;">
        <h1 style="font-size: 80px; text-align: center; font-family: 'Comic Neue';">Blog Wiesława Pięcigróda</h1>
        <h2 style="font-size: 50px; text-align: center; margin-bottom: 50px;">BLOG WIESŁAWA PIĘCIGRÓDA</h2>

        {% for post in site.categories.wieslaw %}
    ...
    <!-- Stopka -->
    <div class="container" style="background-color: #7c7c7c; width: 100%;">
        <p style="font-size: 50px; text-align: center; font-family: 'Comic Neue'; margin: 0; padding: 20px 0;">
